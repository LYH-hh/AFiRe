...
class StudentWrapper(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        distribution_Q = self.head(latent_z[:, 1:, :])
        reconstruct_img, patches_labels = self.decoder(latent_z, mask)

        return distribution_Q, reconstruct_img, patches_labels
